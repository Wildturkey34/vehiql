...
const router = useRouter()
 ...
 useEffect(() => {
  if(processImageResult?.success) { // Changed from processImageError?.success
    ...
    toast.success("Successfully extracted car details from image", {
    ...
    setActiveTab("manual"); // Added quotes to make it a string
  }
...
return (
    ...
    <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
      ...
      <div className='space-y-2'>
        ...
        <div className='space-y-2'>
          ...
          <Input id ="year" {...register("year")} placeholder ="e.g. 2022" className={errors.year ? "border-red-500":""}/>
          {
            errors.year && (
            <p className="text-red-500 text-xs">
              {errors.year.message}
        ...
        <div className='space-y-2'>
          ...
          <Input id ="price" {...register("price")} placeholder ="e.g. 50000" className={errors.price ? "border-red-500":""}/>
          {
            errors.price && (
            <p className="text-red-500 text-xs">
        ...
        <div className='space-y-2'>
          ...
          <Input id ="mileage" {...register("mileage")} placeholder ="e.g. 40 km/hr" className={errors.mileage ? "border-red-500":""}/>
          {
            errors.mileage && (
            <p className="text-red-500 text-xs">
        ...
        <div className='space-y-2'>
          ...
          <Input id ="color" {...register("color")} placeholder ="e.g. Blue" className={errors.color ? "border-red-500":""}/>
          {
            errors.color && (
            <p className="text-red-500 text-xs">
  ...
  <SelectTrigger className={errors.fuelType ? "text-red-500 text-xs": ""}>
  ...
  <SelectTrigger className={errors.transmission ? "text-red-500 text-xs": ""}>
  ...
  >
    <SelectTrigger className={errors.bodyType ? "text-red-500 text-xs" : ""}>
...
<Input id="seats" {...register("seats")} placeholder="e.g. 5"/>
  ...
  >
    <SelectTrigger className={errors.status ? "text-red-500 text-xs" : ""}>
...
<Textarea  id="description" {...register("description")} placeholder="Enter detailed description of the car..." className={`min h-32 ${errors.description ? "border-red-500" : ""}`}/>
{
    errors.description && (
            <p className="text-red-500 text-xs">
...
<div className='flex items-start space-x-3 space-y-0 rounded-md border p-4'>
  ...
  <div className='space-y-1 leading-none'>
    ...
    <p className='text-sm text-gray-500'>Featured Cars appear on the homepage</p>
      ...
      <div>
        <Label htmlFor="images" className={imageError?"border-red-500" :""}>Images
          {imageError && <span className='text-red-500 text-xs'>*</span>}
        </Label>
        <div {...getMultiImageRootProps()} className={`mt-2 border-2 border-dashed rounded-lg p-6 text-center cursor-pointer hover-bg-gray-50 transition ${imageError ? "border-red-500" : "border-gray-300"}`}> 
    ...
    <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4'>
      {uploadedImages.map((image, index) => (
        <div key={index} className='relative group'> 
          <Image 
            src={image} // Make sure `image` contains a valid URL or path
            ...
            priority 
          />
          <Button type="button" size="icon" variant="destructive" className="absolute top-1 right-1 h-6 w-6 opacity-0 group-hover:opacity-100 transition-opacity"
...
<Button type="submit" className='w-full md:w-auto' disabled={addCarLoading}> 
  ...
  <Card>
  <CardHeader>
    <CardTitle>AI Powered Car Deatils Extraction </CardTitle>
    <CardDescription>Upload an image of a car and let AI Extract it's details</CardDescription>
  </CardHeader>
  <CardContent>
    <div className='space-y-6'>
        ...
        {imagePreview?(
          <div className='flex flex-col items-center'>
              <img src={imagePreview} alt="carPreview" className='max-h-56 max-w-full object-contain mb-4' />
        ...
        <div className='bg-gray-50 -4 rounded-md'>
          <h3 className='font-medium mb-2'>How It Works</h3>
          <ol className='space-y-2 text-sm text-gray-600 list-decimal pl-4'>
            <li>Upload a clear image of the car</li>
            <li>Click "Extract Deatils" to analyze with Gemini AI</li>
            <li>Review the extracted information</li>
            <li>Fill in any missing details manually</li>
            <li>Add car to your inventory</li>
          </ol>
        </div>
