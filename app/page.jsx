      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
           {carMakes.map((make) =>{
              return<Link key={make.name} href={`/cars?make=${make.name}`}
              className="bgwhite rounded-lg shadow p-4 text-center hover:shadow-md transition cursor-pointer">
        ...
        <div className="container mx-auto px-4 text-center"> 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Thousands  of verified vehicles from trusted dealerships and private seller.</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 text-blue-700 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
           {bodyTypes.map((type) =>{
              return<Link key={type.name} href={`/cars?bodyType=${type.name}`}
              className="relative group cursor-pointer">
                <div className="overflow-hidden rounded-lg flex justify-end h-28 mb-4 relative">
                  <Image src={type.image} alt={type.name} fill className="object-cover group-hover:scale-105 trasition duration-300" />
                </div>
